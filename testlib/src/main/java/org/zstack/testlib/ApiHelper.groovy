...
trait ApiHelper {
    ...
    def queryResource(@DelegatesTo(strategy = Closure.OWNER_FIRST, value = org.zstack.sdk.QueryResourceAction.class) Closure c) {
        def a = new org.zstack.sdk.QueryResourceAction()
        a.sessionId = Test.currentEnvSpec?.session?.uuid
        c.resolveStrategy = Closure.OWNER_FIRST
        c.delegate = a
        c()
